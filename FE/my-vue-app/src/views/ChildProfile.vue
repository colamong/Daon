<template>
  <div class="py-8 px-4">
    <div class="mx-auto max-w-4xl bg-white pt-10 pb-10 rounded-2xl mb-10">
      <!-- 상단 타이틀 -->
      ...
      <div v-else class="space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 px-8">
          ...
          <div class="flex flex-col items-center space-y-6">
            <div class="relative">
              <img
                :src="selectedChild.profileImage || 'https://placehold.co/300x300'"
                alt="아이 프로필"
                class="w-72 h-72 rounded-full object-cover border-6 border-purple-200 shadow-xl"
              />
            </div>
            <h2 class="text-3xl font-paperBold text-gray-800">{{ selectedChild.name }}</h2>
          </div>
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-gray-50 rounded-xl p-6">
              <h3 class="text-2xl font-paperBold text-gray-800 mb-4">기본 정보</h3>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center space-x-3">
                  <span class="text-purple-500 font-paperBold">🎂</span>
                  <div>
                    <p class="text-sm text-gray-500">생년월일</p>
                    <p class="text-lg font-paper">{{ selectedChild.birthDate }}</p>
                  </div>
                </div>
                <div class="flex items-center space-x-3">
                  <span class="text-purple-500 font-paperBold">👶</span>
                  <div>
                    ...
                    <p class="text-lg font-paper">{{ calculateAge(selectedChild.birthDate) }}세 (만 {{ calculateAge(selectedChild.birthDate) - 1 }}세)</p>
                  </div>
                </div>
                <div class="flex items-center space-x-3">
                  <span class="text-purple-500 font-paperBold">⚧</span>
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-lg font-paper">{{ formatDate(selectedChild.registeredAt) }}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-xl p-6">
              ...
              <div v-if="selectedChild.interests && selectedChild.interests.length > 0" class="flex flex-wrap gap-3">
                <span
              ...
              <p v-else class="text-gray-500 font-paper">등록된 관심사가 없습니다.</p>
            </div>
